...
#cursor.execute("""select * from usuario inner join administrador on usuario.correo=administrador.correo""")

#print(datetime.now())

#cursor.execute("insert into venta(tipo_comprobante,fecha,id_cliente) values('b','1992-01-12 10:00:00.000000',2)")
#conexion.commit()
#conexion.close()
